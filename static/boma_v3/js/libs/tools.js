...
{	
	...
	var getBrowser = function(){
		...
		if (isFF) {
			...
			browser = {"name": "firefox", "version": navigator.userAgent.toLowerCase().match(/firefox\/(.*)/)[1]};
		...
		if (isChrome) {
			...
			browser = {"name": "chrome",  "version": navigator.userAgent.toLowerCase().match(/chrome\/(.* +)/)[1]};
