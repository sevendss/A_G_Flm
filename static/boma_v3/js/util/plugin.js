 ...
 * jquery 插件
 */
// include(window.$path + '/pulgin/jquery-modal-webkit/js/classie');
// include(window.$path + '/pulgin/sweetalert-master/dist/sweetalert.min');
// include(window.$path + '/pulgin/flexslider/jquery.flexslider-min');
// include(window.$path + '/pulgin/ZeroClipboard/ZeroClipboard.min');
// include(window.$path + '/pulgin/ZeroClipboard/ng-clip.min');
...
(function ($) {
    ...
    $.fn.fakeLoader = function(options) {
        ...
        $('body').append('<div class="fakeloader" id="fakeloader"></div>');
        var el = $('#fakeloader');
        ...
        var settings = $.extend({
            ...
            zIndex: '999999999999',  // Default zIndex 
